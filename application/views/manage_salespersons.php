    ...
    <div class="row tile_count">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="x_panel">
                  ...
                  <div class="x_content">
                      <form class="form-horizontal form-label-left validateForm" action="<?php echo base_url(); ?>index.php/settings/addSalesConsultant" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                              <input type="submit" class="btn btn-success deletePerson" value="Add Salesperson"/>
                            </div>
                        </div>
                    </form>
                  </div>
