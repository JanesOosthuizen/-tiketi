<div class="modal fade edit_device" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="<?php echo base_url(); ?>index.php/Jobcard/editJobcardItemProccess">
                <input type="hidden" name="jobcard" id="jobcard" value=""/>
            <input type="hidden" name="deviceId" id="device" value=""/>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <input type="hidden" name="salesperson" id="salesperson" value="<?php echo $user['user_id']; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Technician</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select class="form-control" id="technicianField" name="technician">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select class="form-control" id="deviceType" name="device">
                        ...
                        <div class="x_panel">
                              <div class="x_content">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input type="text" class="form-control" id="serial" name="serial" placeholder="xxxx-xxxx-xxxx-xxxx">
                                        </div>
                                    </div>
                                  <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Warranty / Chargable</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select class="form-control" id="warranty" name="type">
                                              <option value="">Choose option</option>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <div class="col-md- col-sm-9 col-xs-12">
                                <textarea class="form-control" name="description" id="description" placeholder="Full Fault Description"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
